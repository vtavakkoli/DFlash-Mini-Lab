...
def main() -> None:
    ...
    p.add_argument("--mobs-refine-passes", type=int, default=0)
    p.add_argument("--jump-weight", type=float, default=0.5)
    p.add_argument("--fused-jump-weight", type=float, default=1.0)
    p.add_argument("--fused-jump-min-margin", type=float, default=0.0)
    p.add_argument("--boltzmann-temp", type=float, default=0.15, help="Base adaptive temperature for DFlash6-Boltzmann")
    p.add_argument("--bmobs-temp", type=float, default=0.15, help="Base adaptive temperature for DFlash6-BMOBS")
    args = p.parse_args()
    ...
    payload = run_benchmark(
        ...
        args.boltzmann_temp, args.bmobs_temp,
    )
